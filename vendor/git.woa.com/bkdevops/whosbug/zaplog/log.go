...
//  @return ZapLogger
func NewLogger() (zapLogger *ZapLogger) {
	...
	if env.ModuleName == "" {
		log.Fatal("env.ModuleName is empty, check your env 'MODULE_NAME'")
	}
	logBasePath := strings.Join([]string{"/data/logs", env.ModuleName}, "/")
	// 普通日志目录Rotation
