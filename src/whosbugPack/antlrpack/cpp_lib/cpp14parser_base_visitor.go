// Code generated from D:/Desktop/Whosbug_antlr_go/antlr4_cpp/ast_cpp\CPP14Parser.g4 by ANTLR 4.9.1. DO NOT EDIT.
...
func (v *BaseCPP14ParserVisitor) VisitNewExpression(ctx *NewExpressionContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseCPP14ParserVisitor) VisitNewPlacement(ctx *NewPlacementContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseCPP14ParserVisitor) VisitNewTypeId(ctx *NewTypeIdContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseCPP14ParserVisitor) VisitNewDeclarator(ctx *NewDeclaratorContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseCPP14ParserVisitor) VisitNewInitializer(ctx *NewInitializerContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseCPP14ParserVisitor) VisitEmptyDeclaration(ctx *EmptyDeclarationContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseCPP14ParserVisitor) VisitPureSpecifier(ctx *PureSpecifierContext) interface{} {
	return v.VisitChildren(ctx)
}
