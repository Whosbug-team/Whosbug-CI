...
func (s *BaseKotlinParserListener) EnterSetterParameter(ctx *SetterParameterContext) {}

// ExitSetterParameter is called when production setterParameter is exited.
func (s *BaseKotlinParserListener) ExitSetterParameter(ctx *SetterParameterContext) {}
...
func (s *BaseKotlinParserListener) EnterType_(ctx *Type_Context) {}

// ExitType_ is called when production type_ is exited.
func (s *BaseKotlinParserListener) ExitType_(ctx *Type_Context) {}
